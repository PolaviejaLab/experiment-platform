(function() {
     ...
     */
    module.controller('ParticipantListController', ['$scope', '$location', '$routeParams', 'Experiment', 'Participant',
    ...
    module.controller('ParticipantInviteController', ['$scope', '$location', '$routeParams', 'Experiment', 'Participant',
        function ($scope, $location, $routeParams, Experiment, Participant) {
            Experiment.get(
                { id: $routeParams.experimentId },
                function (experiment) {
